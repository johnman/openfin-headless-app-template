...
export async function init(version) {
    ...
    providerBus.onConnection((identity, payload) => {
        ...
        console.log(CHANNEL_NAME + ": Client connection request payload: ", JSON.stringify(payload));
    ...
    providerBus.onDisconnection(async (evt) => {
        ...
        if (connectedClientCount === 0) {
            ...
            if (fin.me.isWindow) {
                ...
                console.warn("The sdk is not hosted in a view or window and so cannot close itself.");
            }
        }
    });
    return providerBus;
